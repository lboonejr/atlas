...
# Parke Bank — 2 more returned items, $285.00 (returning Monday)

Chris Cabezas (Parke Bank) emailed 2026-08-01 ~13:43 UTC (gmail thread
`19fbd91191b09536`, cc mhallworth@parkebank.com) that two items are being
returned Monday morning:
- External Withdrawal — $280.00 : NovusCapital II
- External Withdrawal — $5.00 : Elevate Funding

Same recurring returned-item pattern already tracked on the standing Parke
Bank entity note (`50-Reference/Entities/parke-bank.md`) and prior #decisions
cards (e.g. ts `1785327753` — 3 more returned items, $423.49, saluted). Not
