...
type: log
status: active
tags: [samira, investor, suite420-solutions, lender]
source: gmail
---

# Suite 420 Solutions (Dave Miesner) — financials + PFS needed for term sheet

Josh Evans is corresponding directly with Dave Miesner at Suite 420 Solutions
(lender) on a $250,000 fixed-rate debt investment for [[cuzzies]] (36-48mo term,
18-20%, secured by dispensary assets + personal guarantee). Dave is now building
the term sheet and needs:

1. 2025 Year-End Income Statement + Balance Sheet
2. 2026 YTD Income Statement + Balance Sheet
3. Personal Financial Statement (PFS) for the Guarantor (blank template link sent)

Josh forwarded this to Lemar for visibility (Gmail thread 19f29b5e55c3f621, labeled
Samira/investor). Since Josh is handling the correspondence directly, Samira did not
draft a reply — flagged in #investor-pipeline (ts 1783113103.787389) that the two
financial statements likely come from GreenBooks CPA / QuickBooks and that the PFS
is personal — Lemar's to complete, never drafted or attached by Samira (PII rule).

No Investor Index sheet row added this scan — the sheet
...
## Update 2026-08-18 — rough loan terms sent, before the financials/PFS were confirmed delivered
Dave sent Josh a rough numbers table on the same thread (19f29b5e55c3f621), 10:35am
ET: "I was messing around with some rough numbers this morning and wanted to share
what I came up with." Terms: $250,000 principal, 20.00% annual rate, 36-month term,
3% origination fee ($7,500 upfront), $9,290.90 base monthly P&I + $500 monitoring
fee = $9,790.90 total monthly outflow, no prepayment penalty after month 12 — plus a
full 36-month amortization schedule. Josh forwarded to Lemar ~3:28pm ET.

Framed by Dave as "rough numbers," not a confirmed final term sheet. Nothing on this
thread confirms the 2025 YE/2026 YTD financials or the Guarantor PFS were ever sent
— this appears to be Dave sharing indicative pricing ahead of (or independent of)
receiving those documents. ⚠️ financial terms on thread — Lemar to review closely.
...
- gmail: message (Josh → Lemar, 2026-08-18T15:28:15Z fwd of Dave's 10:35am ET rough loan-terms table)
- slack: #investor-pipeline `C0BCCUKEUQ2` ts 1785788432.311749 (2026-08-03 nudge flagged)
- slack: #investor-pipeline `C0BCCUKEUQ2` ts 1787069861.387379 (2026-08-18 rough loan-terms flagged)
