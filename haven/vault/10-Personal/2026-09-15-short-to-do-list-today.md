...
# Short to-do list — 2026-09-15

Lemar's raw daily to-do drop from Convo 2 (self-DM), verbatim:

1. Take Notary course Days 1 and 2
2. Reach back out to Diaz
3. CRC Cure
4. Follow up with Camden group
5. Continue working on investor docs
6. Close out any open Samira threads
7. (The Station) see if you can complete UEZ app
8. Follow up on Betty Medicaid app
9. Start to figure out the anchor program for grandpa
10. Call Carlos about paying final $500 for the car and plans going forward
11. Figure out what has to be paid by the 18th

## Notes

This is a mixed personal+business batch — no single `domain` fits cleanly, so it is
parked here rather than guessed. Several sub-items likely map to existing tracked
threads and should be split out / cross-linked once domain is resolved:

- Item 4 (Camden group) — likely the Camden Dispensary Launch engagement
  ([[haven/vault/40-Projects/camden-dispensary-launch/index.md]]); item 3 (CRC Cure)
  may also belong there (CRC = NJ Cannabis Regulatory Commission).
- Item 5 (investor docs) — likely the investor pipeline
