...
| Panther Group | Cuzzie's | Michael Teller (COO, The Panther Group) · michael@thepanthergroup.co · (917) 841-0391 | Equity/growth capital reconnect — ~$500K per Lemar's original 6/16 outreach, to cover operational needs and continued growth; no structure/terms set | [folder](https://drive.google.com/drive/folders/1mOyt8U3XUxQyPDQpvtM60E7xuTHThpwc) | Working | Michael replied 7/14 (dormant since 6/16): wants to talk financing. Room built (deck + license + tailored exec summary, $500K figure only, no new terms). Gmail draft reply proposing 3 calendar windows staged, not sent — Lemar's to send | 2026-07-14 |
