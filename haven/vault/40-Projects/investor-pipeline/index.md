...
updated: 2026-07-15T11:50-04:00
domain: project
type: reference
status: active
...
| Panther Group | Cuzzie's | Michael Teller (COO, The Panther Group) · michael@thepanthergroup.co · (917) 841-0391 | Equity/growth capital reconnect — ~$500K per Lemar's original 6/16 outreach, to cover operational needs and continued growth; no structure/terms set | [folder](https://drive.google.com/drive/folders/1mOyt8U3XUxQyPDQpvtM60E7xuTHThpwc) | Sent | Lemar sent his own reply direct 7/14 ~4:18pm ET (bypassed the staged Gmail draft) — pointed Michael to the data room folder, reaffirmed the $500K figure only, no terms committed ("structure and terms we can work out together, nothing is set in stone yet"), asked Michael to propose times and said he'd get it on the calendar. No reply from Michael since — 7/15, Lemar asked for a nudge follow-up; drafted (unsent, in Gmail Drafts) checking if he's had a chance to look at the folder and float times for a call | 2026-07-15 |
