...
updated: 2026-07-22T10:04:52-04:00
domain: reference
type: note
...
## Update 2026-07-22 (10:04 ET)
Haven Inbox card re-asked the filing question ("which project?"); Lemar replied in
thread, "no project — file elsewhere" (2026-07-22T~10:07 ET). Re-domained from
`project` to `reference` (this note documents a Haven-system/routine change, not a
project) and filed to `50-Reference/` per vault-keeper's domain rules.
...
- slack: #decisions (C0BBXA96FFV), Haven Inbox card ts `1784725735.197029`, Lemar's filing reply ts `1784726862.115879`
