...
# Harrison Acquisitions (Centurion Realty AR) — closure reply drafted

Direct request from Lemar: respond to Harrison Acquisitions' accounts receivable
contact. Clarified mid-request that this means **Eldy Bernardez at ar@centurionre.com**
(Centurion Realty, property manager for [[harrison-acquisitions]]) — the recurring
`t0000566` commercial rent billing/ledger thread — not the active litigation
correspondence with opposing counsel Jason Gil (Rivkin Radler).

Drafted (unsent, in Gmail Drafts) — threaded on Eldy's last message in that thread
(2026-02-24, "Please provide us with an update regarding the below"), which had gone
unanswered since. Voice/content mirrors Lemar's own past closure-notice replies to other
past-due contacts (e.g. The Garden Society, 6/23): acknowledges the temporary closure
(June 13, 2026), states Cuzzie's is actively working to reopen, says the balance hasn't
been forgotten, and commits to no dollar figure or timeline.

**Flag for Lemar before sending:** this `t0000566` Harrison Acquisitions arrears is very
likely the same underlying debt at issue in the active litigation
[[harrison-acquisitions-v-cuzzies-cam-lt-004393-26]] (trial scheduled July 30; opposing
counsel Jason Gil has been explicit that consenting to an adjournment depends on
willingness/ability to make a "substantial payment towards the arrears"). Sending
anything to the landlord's side on this same balance while that case is active and
counsel is engaged could have legal significance — recommend Lemar review this against
