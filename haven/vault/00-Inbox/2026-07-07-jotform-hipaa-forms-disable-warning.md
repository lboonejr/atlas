...
Note: a separate Jotform email from 7/6 ("Jotform Account Disabled") already
reported the account disabled for hitting usage limits — this HIPAA warning
may be a second, independent reason forms are/will be down. Given Cuzzie's is
winding down mid-2026, this reads as a low-stakes account-settings choice
(remove HIPAA compliance vs. let forms stay disabled) rather than something
needing Lemar's personal judgment — staging as an admin task for #admin to
review/resolve on a later scan.
