...
| Project channel (work) | **#camden-launch `C0BRZT2V89W`** (private). Staged prompts, artifacts, outcomes. **Bot not yet invited** — see the Slack table. |
