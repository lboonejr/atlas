...
name: samira-loop
description: >
  The build lane: how anything a live Claude thread produces gets landed, pressure-tested,
...
Claude in Chrome does it with Lemar present, or he builds it himself with Samira as project
manager — and whichever lane it takes, it gets pressure-tested across the rest of today's
scans before it counts as finished.
